    ...
    <div className="landing">
      <header className="landing__hero animate-in">
        ...
        <h1 className="landing__title">
          Field Intelligence
          <span className="landing__subtitle">for resilient livelihoods</span>
        </h1>
        <p className="landing__desc">
          Capture field visits, transcribe notes, and produce structured debriefs — so managers
          can see patterns across programs without reading every report.
        </p>
